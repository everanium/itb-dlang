...
/// cores are saturated by libitb3's Go worker pool this cycling
...
package(itb3) ubyte[] retryOnce(size_t cap,
...
/// frees the handle (libitb3 zeroes key material internally). The
...
struct Pipeline
{
    ...
    /// is validated by libitb3). The profile shape travels inside the
...
/// validated by libitb3; a duplicate name fails with
