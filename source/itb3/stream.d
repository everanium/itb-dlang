...
/// libitb3. The destructor cancels the session and frees the Go-side
...
private mixin template SessionBody()
{
    ...
    package(itb3) BorrowedBytes pump(scope const(ubyte)[] src) @trusted
    {
        OwnedBuilder acc;
